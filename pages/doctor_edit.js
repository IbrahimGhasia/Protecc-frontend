...
export default function Home() {
    ...
    const submitData = async (event) => {
        ...
        if (
            ...
            const tableName = await tableland.createTable("doctorProfileTest")
                                ...
                                <div className="text-center mt-5">
                                    {!spinner ? (
                                        ...
                                        <button
                                            disabled
                                            type="button"
                                            class="mb-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-20 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
                                        >
                                            <svg
                                                role="status"
